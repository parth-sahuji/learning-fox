import { WHATSAPP_NUMBER } from './StickyHeader';
  ...
  return (
    <div className="whatsapp-float">
      <a
        ...
        className="group flex items-center gap-2 bg-[#25D366] hover:bg-[#20b858] text-white
                   pl-3 pr-4 py-3 rounded-full shadow-lg hover:shadow-xl
