    ...
    <div className="min-h-screen bg-[var(--bg-primary)]" style={{paddingTop:'68px'}}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-10">
          <img src="/fox-logo.png" alt="Learning Fox" className="w-16 h-16 mx-auto object-contain mb-3"
          ...
          <p className="text-[var(--text-secondary)] text-sm mt-2">Last updated: January 2025 · Learning Fox Tuition Platform</p>
        </div>

        <div className="card space-y-6 text-sm text-[var(--text-primary)] leading-relaxed">

          <section>
            <h2 className="font-display text-lg font-bold text-[var(--text-primary)] mb-2">1. About Learning Fox</h2>
            <p className="text-[var(--text-secondary)]">
              Learning Fox is an online platform that connects students seeking home tuition with qualified home tutors in India.
          ...
          <section>
            ...
            <div className="p-4 rounded-xl bg-red-50 dark:bg-red-950/20 border-l-4 border-red-500">
              ...
              <p className="text-red-600 dark:text-red-400">
                Learning Fox is <strong>strictly not responsible</strong> for any consequences arising from offline arrangements
              ...
              <ul className="mt-2 space-y-1 text-red-600 dark:text-red-400 list-disc list-inside">
                ...
                <li>Any private financial agreements not recorded on Learning Fox</li>
          ...
          <section>
            ...
            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800">
              <ul className="space-y-2 text-[var(--text-secondary)]">
                ...
                <li className="flex items-start gap-2"><span className="text-amber-500 font-bold flex-shrink-0">•</span>
                  <strong className="text-[var(--text-primary)]">If even one month's fee is skipped</strong>, Learning Fox takes no responsibility for the continuation of services or any resulting disputes. The platform owner is not liable for any financial loss arising from missed payments.</li>
                <li className="flex items-start gap-2"><span className="text-amber-500 font-bold flex-shrink-0">•</span>
          ...
          <section>
            ...
            <p className="text-[var(--text-secondary)]">
              ...
              and Learning Fox bears no responsibility for any outcomes thereof.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[var(--text-secondary)]">
              Teachers are required to submit a valid Aadhar card and resume during registration. While Learning Fox reviews
              these documents as part of the approval process, we do not guarantee the authenticity of all claims made by teachers.
              Students are advised to exercise their own judgment. Learning Fox is not liable for any misrepresentation by teachers.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="p-4 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border)]">
              <p className="text-[var(--text-secondary)]">
                Learning Fox (including its owners, administrators, and employees) shall not be held liable for:
              </p>
