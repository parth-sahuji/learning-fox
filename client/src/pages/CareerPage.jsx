      ...
      <div className="min-h-screen relative" style={{ paddingTop: '56px' }}>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-12 text-[var(--text-primary)]">Teach Students Across {loc.city}</h2>
        ...
        <section className="py-16" style={{ background: 'rgba(239,117,32,0.05)' }}>
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-12 text-[var(--text-primary)]">Subjects in Demand</h2>
        ...
        <section className="py-16">
          <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-12 text-[var(--text-primary)]">FAQs: Tutoring Jobs in {loc.city}</h2>
