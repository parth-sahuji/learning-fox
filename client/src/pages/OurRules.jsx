          ...
          <section className="text-center bg-white/5 backdrop-blur-lg border border-white/20 rounded-3xl p-10">
            ...
            <div className="bg-orange-500/20 border border-orange-500/50 rounded-xl p-6 max-w-2xl mx-auto">
              <p className="text-sm text-gray-300">
                ...
                Contact admin at <a href="mailto:Ksl.13021412@gmail.com" className="text-cyan-400 hover:underline">Ksl.13021412@gmail.com</a> or call <a href="tel:+918340173069" className="text-cyan-400 hover:underline">+91-8340173069</a>
              </p>
            </div>
          </section>
