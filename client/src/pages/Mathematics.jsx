      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <Link to="/register?role=student" className="inline-block bg-gradient-to-r from-blue-600 to-purple-700 text-white px-10 py-5 rounded-full font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all">
